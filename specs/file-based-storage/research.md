...
**Created:** 2026-02-16
**Source:** `02-16-file-based-memory-PRD.md`
**Status:** In Progress
...
This research document covers the investigation of file-based storage patterns, indexing strategies, and migration approaches for replacing SQLite with a pure file-based storage system.

**Research Questions:**
1. What are best practices for file-based storage in CLI applications?
2. How can we efficiently implement search/indexing without FTS5?
3. What are proven migration strategies for data format changes?
4. What atomic file write patterns ensure data integrity?
5. How do other CLI tools (git, docker, npm) structure their file-based data?

**For full details, see the source PRD:** `02-16-file-based-memory-PRD.md`
